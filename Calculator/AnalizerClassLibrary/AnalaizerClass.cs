...
namespace AnalaizerClassLibrary
{
    ...
    public static class AnalaizerClass
    {
        ...
        public static bool CheckCurrency()
        {
            ...
            if (openBracket.Count > 0) // якщо кількість відкриваючих дужок, быльше кількості закриваючих
            {
        ...
        {
            expression = expression.Replace(" ", "");    // видаляємо всі пробіли у виразі
            ...
            for (int i = 0; i < expression.Length; i++)
            {
                ...
                // перевірка наступного символа після цифри
                if (char.IsDigit(currentSymbol))
                {
                ...
                // перевірка на символи після унарного оператора
